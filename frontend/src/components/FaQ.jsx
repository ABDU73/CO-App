  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between m-12">
        <h1 className="text-3xl font-semibold text-gray-800">FaQs</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="border-b pb-4">
          <div
            className="flex justify-between items-center cursor-pointer py-3 text-xl font-medium text-gray-700"
            onClick={() => toggleFAQ(0)}
          >
            <h2>Who We Are?</h2>
            <IoIosArrowDropdown className={`transform transition-transform delay-100 duration-100  ${activeFAQ === 0 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 0 && (
            <div className="pl-6 text-gray-600 transform transition-transform delay-100 duration-100">
        ...
        <div className="border-b pb-4">
          ...
          >
            ...
            <IoIosArrowDropdown className={`transform transition-transform ${activeFAQ === 1 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 1 && (
        ...
        <div className="border-b pb-4">
          ...
          >
            <h2>What We Do?</h2>
            <IoIosArrowDropdown className={`transform transition-transform ${activeFAQ === 2 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 2 && (
            <div className="pl-6 text-gray-600">
        ...
        <div className="border-b pb-4">
          ...
          >
            ...
            <IoIosArrowDropdown className={`transform transition-transform ${activeFAQ === 3 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 3 && (
            <div className="pl-6 text-gray-600">
        ...
        <div className="border-b pb-4">
          ...
          >
            ...
            <IoIosArrowDropdown className={`transform transition-transform ${activeFAQ === 4 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 4 && (
            <div className="pl-6 text-gray-600">
        ...
        <div>
          ...
          >
            <h2>Contact Us</h2>
            <IoIosArrowDropdown className={`transform transition-transform ${activeFAQ === 5 ? 'rotate-180' : ''}`} size="30px" />
          </div>
          {activeFAQ === 5 && (
            <div className="pl-6 text-gray-600">
